...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '../assets/images/PPOTTS Logo 2023.avif');
}
...
function layout_theme_sidebar_change(value) {
  if (value == 'true') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/PPOTTS Logo 2023.avif');
    }
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../assets/images/PPOTTS Logo 2023.avif');
    }
    if (document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg')) {
      document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/PPOTTS Logo 2023.avif');
    }
    if (document.querySelector('.auth-wrapper a>img')) {
      document.querySelector('.auth-wrapper a>img').setAttribute('src', '../assets/images/PPOTTS Logo 2023.avif');
    }
